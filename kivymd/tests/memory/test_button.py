"""
Test that MDButton does not leak theme observers when widgets are
created and removed repeatedly.

The test continuously replaces the button widget on a screen, tracks
the number of theme style observers, and verifies that removing old
buttons does not increase the number of registered callbacks.
"""
