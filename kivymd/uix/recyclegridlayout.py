...
.. tabs::
    ...
    .. tab:: Declarative python style
        ...
        .. code-block:: python
            ...
            from kivymd.uix.recyclegridlayout import IOSRecycleGridLayout
            from kivymd.app import MDApp

            class MyApp(App):
                def build(self):
                    return IOSRecycleGridLayout(
