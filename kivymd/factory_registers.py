...
r("IconRightWidget", module="kivymd.uix.list")
r("IconLeftWidget", module="kivymd.uix.list")
r("ImageRightWidget", module="kivymd.uix.list")
r("ImageLeftWidget", module="kivymd.uix.list")
