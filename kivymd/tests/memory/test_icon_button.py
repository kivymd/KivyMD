"""
Test that MDIconButton does not leak theme observers when widgets are
...
MDIconButton instances does not increase the number of registered callbacks.
"""
...
class TestButtonMemoryLeak(MDApp):
    ...
    def add_items(self, *args):
        ...
        self.root.add_widget(MDIconButton(icon="plus"))
